...
{
	internal class DE6InteriorLOD0MeshSplitter
	{
		public static GameObject SplitLocoInteriorLOD0
		{ get; private set; }
		...
		private static readonly RangeFloat controlStand1LimitX = new(-0.8f, -0.3f);
		...
		private static readonly RangeFloat controlStand2LimitX = new(-0.881f, -0.33f);
		...
		public const int CAB_MESH_PATHID = 4406;

		internal static void Init()
		{
			SplitLocoInteriorLOD0 = SplitMesh();
			UnityEngine.Object.DontDestroyOnLoad(SplitLocoInteriorLOD0);
		}
		...
		private static GameObject SplitMesh()
		{
			...
			GameObject splitLocoInteriorLOD0 = new GameObject("Cab");
			splitLocoInteriorLOD0.SetActive(false);
			...
			splitInterior.transform.SetParent(splitLocoInteriorLOD0.transform);
			...
			GameObject controlStand1 = UnityEngine.Object.Instantiate(splitInterior, splitLocoInteriorLOD0.transform);
			controlStand1.GetComponent<MeshFilter>().mesh = controlStand1Mesh;
			controlStand1.name = "de6_control_stand_1";

			GameObject controlStand2 = UnityEngine.Object.Instantiate(splitInterior, splitLocoInteriorLOD0.transform);
			controlStand2.GetComponent<MeshFilter>().mesh = controlStand2Mesh;
			controlStand2.name = "de6_control_stand_2";

			GameObject speedo = UnityEngine.Object.Instantiate(splitInterior, splitLocoInteriorLOD0.transform);
			speedo.GetComponent<MeshFilter>().mesh = speedoMesh;
			speedo.name = "de6_speedometer";

			GameObject handrail = UnityEngine.Object.Instantiate(splitInterior, splitLocoInteriorLOD0.transform);
			handrail.GetComponent<MeshFilter>().mesh = handrailMesh;
			handrail.name = "de6_handrail";

			GameObject heater = UnityEngine.Object.Instantiate(splitInterior, splitLocoInteriorLOD0.transform);
			heater.GetComponent<MeshFilter>().mesh = heaterMesh;
			heater.name = "de6_heater";

			GameObject heaterHose = UnityEngine.Object.Instantiate(splitInterior, splitLocoInteriorLOD0.transform);
			heaterHose.GetComponent<MeshFilter>().mesh = heaterHoseMesh;
			heaterHose.name = "de6_heater_hose";

			GameObject table = UnityEngine.Object.Instantiate(splitInterior, splitLocoInteriorLOD0.transform);
			table.GetComponent<MeshFilter>().mesh = tableMesh;
			table.name = "de6_table";

			GameObject toiletDoor = UnityEngine.Object.Instantiate(splitInterior, splitLocoInteriorLOD0.transform);
			toiletDoor.GetComponent<MeshFilter>().mesh = toiletDoorMesh;
			toiletDoor.name = "de6_front_hood_door";

			GameObject cabinet = UnityEngine.Object.Instantiate(splitInterior, splitLocoInteriorLOD0.transform);
			cabinet.GetComponent<MeshFilter>().mesh = cabinetMesh;
			cabinet.name = "de6_cabinet";

			GameObject cabLight = UnityEngine.Object.Instantiate(splitInterior, splitLocoInteriorLOD0.transform);
