...
{
	internal class DE6LOD1MeshSplitter
	{
		...
		private static GameObject SplitMesh()
		{
			...
			Main.Logger.Log($"Splitting diesel_body_LOD1 mesh...");

			GameObject splitLocoBodyLOD1 = new GameObject("diesel_body_LOD1");
			...
			GameObject plowF = UnityEngine.Object.Instantiate(splitLoco, splitLocoBodyLOD1.transform);
			plowF.GetComponent<MeshFilter>().mesh = plowFMesh;
			plowF.name = "de6_plow_f";

			GameObject plowR = UnityEngine.Object.Instantiate(splitLoco, splitLocoBodyLOD1.transform);
			plowR.GetComponent<MeshFilter>().mesh = plowRMesh;
			plowR.name = "de6_plow_r";

			GameObject doorHinges = UnityEngine.Object.Instantiate(splitLoco, splitLocoBodyLOD1.transform);
			doorHinges.GetComponent<MeshFilter>().mesh = doorHingesMesh;
			doorHinges.name = "de6_door_hinges";

			GameObject handrailF = UnityEngine.Object.Instantiate(splitLoco, splitLocoBodyLOD1.transform);
			handrailF.GetComponent<MeshFilter>().mesh = handrailFMesh;
			handrailF.name = "de6_handrail_f";

			GameObject handrailLF = UnityEngine.Object.Instantiate(splitLoco, splitLocoBodyLOD1.transform);
			handrailLF.GetComponent<MeshFilter>().mesh = handrailLFMesh;
			handrailLF.name = "de6_handrail_lf";

			GameObject handrailRF = UnityEngine.Object.Instantiate(splitLoco, splitLocoBodyLOD1.transform);
			handrailRF.GetComponent<MeshFilter>().mesh = handrailRFMesh;
			handrailRF.name = "de6_handrail_rf";

			GameObject handrailLM = UnityEngine.Object.Instantiate(splitLoco, splitLocoBodyLOD1.transform);
			handrailLM.GetComponent<MeshFilter>().mesh = handrailLMMesh;
			handrailLM.name = "de6_handrail_lm";

			GameObject handrailRM = UnityEngine.Object.Instantiate(splitLoco, splitLocoBodyLOD1.transform);
			handrailRM.GetComponent<MeshFilter>().mesh = handrailRMMesh;
			handrailRM.name = "de6_handrail_rm";

			GameObject handrailLR = UnityEngine.Object.Instantiate(splitLoco, splitLocoBodyLOD1.transform);
			handrailLR.GetComponent<MeshFilter>().mesh = handrailLRMesh;
			handrailLR.name = "de6_handrail_lr";

			GameObject handrailRR = UnityEngine.Object.Instantiate(splitLoco, splitLocoBodyLOD1.transform);
			handrailRR.GetComponent<MeshFilter>().mesh = handrailRRMesh;
			handrailRR.name = "de6_handrail_rr";

			GameObject handrailTopL = UnityEngine.Object.Instantiate(splitLoco, splitLocoBodyLOD1.transform);
			handrailTopL.GetComponent<MeshFilter>().mesh = handrailTopLMesh;
			handrailTopL.name = "de6_handrail_top_l";

			GameObject handrailTopR = UnityEngine.Object.Instantiate(splitLoco, splitLocoBodyLOD1.transform);
			...
			GameObject headlightF = UnityEngine.Object.Instantiate(splitLoco, splitLocoBodyLOD1.transform);
			headlightF.GetComponent<MeshFilter>().mesh = headlightFMesh;
			headlightF.name = "de6_headlight_f";

			GameObject headlightFUpper = UnityEngine.Object.Instantiate(splitLoco, splitLocoBodyLOD1.transform);
			headlightFUpper.GetComponent<MeshFilter>().mesh = upperHeadlightMesh;
			headlightFUpper.name = "de6_headlight_f_upper";

			GameObject headlightR = UnityEngine.Object.Instantiate(splitLoco, splitLocoBodyLOD1.transform);
			headlightR.GetComponent<MeshFilter>().mesh = headlightRMesh;
			headlightR.name = "de6_headlight_r";

			GameObject ditchLightRF = UnityEngine.Object.Instantiate(splitLoco, splitLocoBodyLOD1.transform);
			ditchLightRF.GetComponent<MeshFilter>().mesh = ditchLightRFMesh;
			ditchLightRF.name = "de6_ditch_light_rf";

			GameObject ditchLightLF = UnityEngine.Object.Instantiate(splitLoco, splitLocoBodyLOD1.transform);
			ditchLightLF.GetComponent<MeshFilter>().mesh = ditchLightLFMesh;
			ditchLightLF.name = "de6_ditch_light_lf";

			GameObject ditchLightRR = UnityEngine.Object.Instantiate(splitLoco, splitLocoBodyLOD1.transform);
			ditchLightRR.GetComponent<MeshFilter>().mesh = ditchLightRRMesh;
			ditchLightRR.name = "de6_ditch_light_rr";

			GameObject ditchLightLR = UnityEngine.Object.Instantiate(splitLoco, splitLocoBodyLOD1.transform);
			ditchLightLR.GetComponent<MeshFilter>().mesh = ditchLightLRMesh;
			ditchLightLR.name = "de6_ditch_light_lr";

			GameObject shortHood = UnityEngine.Object.Instantiate(splitLoco, splitLocoBodyLOD1.transform);
			shortHood.GetComponent<MeshFilter>().mesh = shortHoodMesh;
			shortHood.name = "de6_short_hood";

			GameObject shortHoodBase = UnityEngine.Object.Instantiate(splitLoco, splitLocoBodyLOD1.transform);
			shortHoodBase.GetComponent<MeshFilter>().mesh = shortHoodBaseMesh;
			shortHoodBase.name = "de6_short_hood_base";

			GameObject numberBoards = UnityEngine.Object.Instantiate(splitLoco, splitLocoBodyLOD1.transform);
			numberBoards.GetComponent<MeshFilter>().mesh = numberBoardsMesh;
			numberBoards.name = "de6_number_boards";

			GameObject horn = UnityEngine.Object.Instantiate(splitLoco, splitLocoBodyLOD1.transform);
			...
			GameObject longHood = UnityEngine.Object.Instantiate(splitLoco, splitLocoBodyLOD1.transform);
			longHood.GetComponent<MeshFilter>().mesh = longHoodMesh;
			longHood.name = "de6_long_hood";

			GameObject fan1 = UnityEngine.Object.Instantiate(splitLoco, splitLocoBodyLOD1.transform);
			fan1.GetComponent<MeshFilter>().mesh = fan1Mesh;
			fan1.name = "de6_fan_1";

			GameObject fan2 = UnityEngine.Object.Instantiate(splitLoco, splitLocoBodyLOD1.transform);
			fan2.GetComponent<MeshFilter>().mesh = fan2Mesh;
			fan2.name = "de6_fan_2";

			GameObject fan3 = UnityEngine.Object.Instantiate(splitLoco, splitLocoBodyLOD1.transform);
			fan3.GetComponent<MeshFilter>().mesh = fan3Mesh;
			fan3.name = "de6_fan_3";

			GameObject fan4 = UnityEngine.Object.Instantiate(splitLoco, splitLocoBodyLOD1.transform);
			fan4.GetComponent<MeshFilter>().mesh = fan4Mesh;
			fan4.name = "de6_fan_4";

			GameObject exhaust = UnityEngine.Object.Instantiate(splitLoco, splitLocoBodyLOD1.transform);
