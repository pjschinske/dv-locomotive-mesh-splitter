...
namespace LocoMeshSplitter.MeshSplitters.S060
{
	internal class S060LOD1MeshSplitter
	{
		...
		private static GameObject SplitMesh()
		{
			...
			GameObject tankMount = UnityEngine.Object.Instantiate(splitLoco, splitLocoBodyLOD1.transform);
			tankMount.GetComponent<MeshFilter>().mesh = tankMountMesh;
			tankMount.name = "s060_tank_mount";

			GameObject tankMountUpperMount = UnityEngine.Object.Instantiate(splitLoco, splitLocoBodyLOD1.transform);
			...
			GameObject tankMountLowerMount = UnityEngine.Object.Instantiate(splitLoco, splitLocoBodyLOD1.transform);
			...
			GameObject tankFloor = UnityEngine.Object.Instantiate(splitLoco, splitLocoBodyLOD1.transform);
			...
			GameObject equalizerPipe = UnityEngine.Object.Instantiate(splitLoco, splitLocoBodyLOD1.transform);
			equalizerPipe.GetComponent<MeshFilter>().mesh = equalizerPipeMesh;
			equalizerPipe.name = "s060_equalizer_pipe";

			GameObject steamDome = UnityEngine.Object.Instantiate(splitLoco, splitLocoBodyLOD1.transform);
			steamDome.GetComponent<MeshFilter>().mesh = steamDomeMesh;
			steamDome.name = "s060_steam_dome";

			GameObject sandDomeF = UnityEngine.Object.Instantiate(splitLoco, splitLocoBodyLOD1.transform);
			sandDomeF.GetComponent<MeshFilter>().mesh = sandDomeFMesh;
			sandDomeF.name = "s060_sand_dome_f";

			GameObject sandDomeR = UnityEngine.Object.Instantiate(splitLoco, splitLocoBodyLOD1.transform);
			sandDomeR.GetComponent<MeshFilter>().mesh = sandDomeRMesh;
			sandDomeR.name = "s060_sand_dome_r";

			GameObject sandPipesF = UnityEngine.Object.Instantiate(splitLoco, splitLocoBodyLOD1.transform);
			sandPipesF.GetComponent<MeshFilter>().mesh = sandPipesFMesh;
			sandPipesF.name = "s060_sand_pipes_f";

			GameObject sandPipesR = UnityEngine.Object.Instantiate(splitLoco, splitLocoBodyLOD1.transform);
			sandPipesR.GetComponent<MeshFilter>().mesh = sandPipesRMesh;
			sandPipesR.name = "s060_sand_pipes_r";

			GameObject whistleL = UnityEngine.Object.Instantiate(splitLoco, splitLocoBodyLOD1.transform);
			whistleL.GetComponent<MeshFilter>().mesh = whistleLMesh;
			whistleL.name = "s060_whistle_l";

			GameObject whistleR = UnityEngine.Object.Instantiate(splitLoco, splitLocoBodyLOD1.transform);
			whistleR.GetComponent<MeshFilter>().mesh = whistleRMesh;
			whistleR.name = "s060_whistle_r";

			GameObject whistleLinkage = UnityEngine.Object.Instantiate(splitLoco, splitLocoBodyLOD1.transform);
			...
			GameObject whistleBracket = UnityEngine.Object.Instantiate(splitLoco, splitLocoBodyLOD1.transform);
			whistleBracket.GetComponent<MeshFilter>().mesh = whistleBracketMesh;
			whistleBracket.name = "s060_whistle_bracket";

			GameObject headlight = UnityEngine.Object.Instantiate(splitLoco, splitLocoBodyLOD1.transform);
			headlight.GetComponent<MeshFilter>().mesh = headlightMesh;
			headlight.name = "s060_headlight";

			GameObject headlightBracket = UnityEngine.Object.Instantiate(splitLoco, splitLocoBodyLOD1.transform);
			headlightBracket.GetComponent<MeshFilter>().mesh = headlightBracketMesh;
			headlightBracket.name = "s060_headlight_bracket";

			GameObject dynamoToHeadlight = UnityEngine.Object.Instantiate(splitLoco, splitLocoBodyLOD1.transform);
			dynamoToHeadlight.GetComponent<MeshFilter>().mesh = dynamoToHeadlightMesh;
			dynamoToHeadlight.name = "s060_dynamo_to_headlight";

			GameObject dynamoToHeadlightCtrl = UnityEngine.Object.Instantiate(splitLoco, splitLocoBodyLOD1.transform);
			...
			GameObject headlightLowerLeft = UnityEngine.Object.Instantiate(splitLoco, splitLocoBodyLOD1.transform);
			headlightLowerLeft.GetComponent<MeshFilter>().mesh = headlightLowerLeftMesh;
			headlightLowerLeft.name = "s060_headlight_lower_left";

			GameObject headlightLowerRight = UnityEngine.Object.Instantiate(splitLoco, splitLocoBodyLOD1.transform);
			...
			GameObject taillightUpper = UnityEngine.Object.Instantiate(splitLoco, splitLocoBodyLOD1.transform);
			taillightUpper.GetComponent<MeshFilter>().mesh = taillightUpperMesh;
			taillightUpper.name = "s060_taillight_upper";

			GameObject taillightLowerLeft = UnityEngine.Object.Instantiate(splitLoco, splitLocoBodyLOD1.transform);
			taillightLowerLeft.GetComponent<MeshFilter>().mesh = taillightLowerLeftMesh;
			taillightLowerLeft.name = "s060_taillight_lower_left";

			GameObject taillightLowerRight = UnityEngine.Object.Instantiate(splitLoco, splitLocoBodyLOD1.transform);
			...
			GameObject bunker = UnityEngine.Object.Instantiate(splitLoco, splitLocoBodyLOD1.transform);
			bunker.GetComponent<MeshFilter>().mesh = bunkerMesh;
			bunker.name = "s060_bunker";

			GameObject rearSubframeLeft = UnityEngine.Object.Instantiate(splitLoco, splitLocoBodyLOD1.transform);
			rearSubframeLeft.GetComponent<MeshFilter>().mesh = rearSubframeLeftMesh;
			rearSubframeLeft.name = "s060_rear_subframe_left";

			GameObject rearSubframeRight = UnityEngine.Object.Instantiate(splitLoco, splitLocoBodyLOD1.transform);
			rearSubframeRight.GetComponent<MeshFilter>().mesh = rearSubframeRightMesh;
			rearSubframeRight.name = "s060_rear_subframe_right";

			GameObject bumper = UnityEngine.Object.Instantiate(splitLoco, splitLocoBodyLOD1.transform);
			...
			GameObject smokeboxBolts = UnityEngine.Object.Instantiate(splitLoco, splitLocoBodyLOD1.transform);
			smokeboxBolts.GetComponent<MeshFilter>().mesh = smokeboxBoltsMesh;
			smokeboxBolts.name = "s060_smokebox_bolts";

			GameObject handleFrontLeft = UnityEngine.Object.Instantiate(splitLoco, splitLocoBodyLOD1.transform);
			...
			GameObject airPipes1 = UnityEngine.Object.Instantiate(splitLoco, splitLocoBodyLOD1.transform);
			...
			GameObject guttersF = UnityEngine.Object.Instantiate(splitLoco, splitLocoBodyLOD1.transform);
			...
			GameObject boilerJacket1 = UnityEngine.Object.Instantiate(splitLoco, splitLocoBodyLOD1.transform);
			boilerJacket1.GetComponent<MeshFilter>().mesh = boilerJacket1Mesh;
			boilerJacket1.name = "s060_boiler_jacket_1";

			GameObject boilerJacket2 = UnityEngine.Object.Instantiate(splitLoco, splitLocoBodyLOD1.transform);
			boilerJacket2.GetComponent<MeshFilter>().mesh = boilerJacket2Mesh;
			boilerJacket2.name = "s060_boiler_jacket_2";

			GameObject boilerJacket3 = UnityEngine.Object.Instantiate(splitLoco, splitLocoBodyLOD1.transform);
			boilerJacket3.GetComponent<MeshFilter>().mesh = boilerJacket3Mesh;
			boilerJacket3.name = "s060_boiler_jacket_3";

			GameObject boilerBand1 = UnityEngine.Object.Instantiate(splitLoco, splitLocoBodyLOD1.transform);
			boilerBand1.GetComponent<MeshFilter>().mesh = boilerBand1Mesh;
			boilerBand1.name = "s060_boiler_band_1";

			GameObject boilerBand2 = UnityEngine.Object.Instantiate(splitLoco, splitLocoBodyLOD1.transform);
