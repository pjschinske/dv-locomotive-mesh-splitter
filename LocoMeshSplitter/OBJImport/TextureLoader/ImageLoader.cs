...
namespace Dummiesman
{
	internal class ImageLoader
    {
		...
		internal static void SetNormalMap(ref Texture2D tex)
        {
		...
		/// <returns></returns>
		internal static Texture2D LoadTexture(Stream stream, TextureFormat format)
        {
            return null;
        }
		...
		/// <returns></returns>
		internal static Texture2D LoadTexture(string fn)
        {
			return null;
        }
